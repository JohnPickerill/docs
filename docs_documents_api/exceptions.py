...
from docs_documents_api.utils.content_negotiation_utils import request_wants_json
...
def unhandled_exception(e):
    ...
    return jsonify({'code':http_code, 'message': repr(e)}), http_code
...
def application_error(e):
    ...
    if e.http_code in [500, 404, 403, 400, 429]:
